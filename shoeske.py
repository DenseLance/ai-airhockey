...
class Player:
    def __init__(self, paddle_pos, goal_side):
        ...
        self.rewards = {"self_score": 10, "block": 5, "opponent_score": -10} # if score, dont give block reward
    ...
    ##            self.start_shooting_position = {"x": current_state["board_shape"][1] * 0.24 if self.my_goal == "left" else current_state["board_shape"][1] * 0.76, "y": current_state["board_shape"][0] / 2}
